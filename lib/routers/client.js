 ...
 * @apiSuccess {String} data.type Medium used by client i.e web, mobile, desktop etc.
 * @apiSuccess {String} data.secret Secret of the client
 * @apiSuccess {String} data.name Human readable name of the client e.g FooBar etc.
 * @apiSuccess {String[]} data.grants Allowed grant types forh the client e.g password etc.
 * @apiSuccess {String[]} data.redirectUris Allowed redirect uris for the client
 * @apiSuccess {NUmber} data.refreshTokenLifetime Client specific lifetime of generated refresh tokens in seconds
 * @apiSuccess {Number} data.accessTokenLifetime Client specific lifetime of generated access tokens in seconds
 * @apiSuccess {Number} data.authorizationCodeLifetime Client specific lifetime of generated access tokens in seconds
 ...
 *     "data": [
 *       {
 *         "_id": "5ac88c5350f2e0158ef8e197",
 *         "type": "web",
 *         "secret": "8ac9e54f8842d4489195",
 *         "name": "Web Client",
 *         "grants": [],
 *         "redirectUris": [],
 ...
 *         "createdAt": "2018-04-07T09:16:03.081Z",
 *         "updatedAt": "2018-04-07T09:16:03.081Z"
 *       }
 *     ],
 *     "total": 0,
 *     "size": 0,
