...
const CLIENT_AUTOPOPULATE = _.merge({ path: 'client' },
  Client.OPTION_AUTOPOPULATE,
  OPTION_AUTOPOPULATE
);

const USER_AUTOPOPULATE = _.merge({ path: 'user' },
  User.OPTION_AUTOPOPULATE,
  OPTION_AUTOPOPULATE
);
...
const TokenSchema = new Schema({
  ...
  user: {
    ...
    exists: true,
    index: true,
    autopopulate: USER_AUTOPOPULATE
  },
  ...
  client: {
    type: ObjectId,
    ref: Client.MODEL_NAME,
    // required: true,
    autoset: true,
    exists: true,
    index: true,
    autopopulate: CLIENT_AUTOPOPULATE
  },
